...
const HOWTO_JSON_LD = {"@context":"https://schema.org","@type":"HowTo","name":"퍼센트 계산기 사용 방법","description":"6가지 모드 — 백분율·증감률·할인·팁·비율.","inLanguage":"ko-KR","totalTime":"PT1M","tool":{"@type":"WebApplication","name":"퍼센트 계산기","url":"https://agent-control-panel-phi.vercel.app/tools/util/percentage"},"step":[{"@type":"HowToStep","position":1,"name":"입력","text":"변환·분석할 텍스트나 데이터를 입력 영역에 붙여넣습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/util/percentage#step1"},{"@type":"HowToStep","position":2,"name":"결과 확인","text":"결과가 실시간으로 표시됩니다. 옵션을 조절해 결과를 다듬을 수 있습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/util/percentage#step2"},{"@type":"HowToStep","position":3,"name":"복사·저장","text":"결과를 클립보드에 복사하거나 파일로 내려받습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/util/percentage#step3"}]} as const;
