...
const URL_PATH = '/tools/dev/color-contrast';
const OG_IMAGE = '/og/dev.png';

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  keywords: ["대비","contrast","wcag","접근성","accessibility","명도","ratio","개발자","브라우저 도구","무료","온라인","no upload"],
  alternates: {
    canonical: URL_PATH,
    languages: {
      'ko-KR': URL_PATH,
      'en': '/en/tools/color-contrast',
      'ja': '/ja/tools/color-contrast',
      'zh': '/zh/tools/color-contrast',
      'x-default': URL_PATH,
    },
  },
  openGraph: {
