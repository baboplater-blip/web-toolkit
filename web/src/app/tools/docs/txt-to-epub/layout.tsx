...
const JSON_LD = {"@context":"https://schema.org","@type":"WebApplication","name":"텍스트 → EPUB","description":"TXT 또는 입력한 텍스트를 EPUB 전자책으로 만듭니다.","url":"https://__SITE_URL__/tools/docs/txt-to-epub","applicationCategory":"BusinessApplication","applicationSubCategory":"문서 변환","operatingSystem":"Any","browserRequirements":"Requires JavaScript and HTML5 Canvas.","inLanguage":"ko-KR","isAccessibleForFree":true,"offers":{"@type":"Offer","price":"0","priceCurrency":"KRW"},"publisher":{"@type":"Organization","name":"Web Toolkit","url":"https://__SITE_URL__"}} as const;
const HOWTO_JSON_LD = {"@context":"https://schema.org","@type":"HowTo","name":"텍스트 → EPUB 사용 방법","description":"TXT 또는 입력한 텍스트를 EPUB 전자책으로 만듭니다.","inLanguage":"ko-KR","totalTime":"PT1M","tool":{"@type":"WebApplication","name":"텍스트 → EPUB","url":"https://__SITE_URL__/tools/docs/txt-to-epub"},"step":[{"@type":"HowToStep","position":1,"name":"파일 업로드","text":"도구 페이지를 열고 변환할 파일을 드롭존에 끌어다 놓거나 선택합니다. 파일은 브라우저 안에서만 처리되며 서버로 전송되지 않습니다.","url":"https://__SITE_URL__/tools/docs/txt-to-epub#step1"},{"@type":"HowToStep","position":2,"name":"옵션 설정","text":"텍스트 → EPUB에 필요한 옵션을 화면에서 선택합니다. 미리보기로 결과를 확인할 수 있습니다.","url":"https://__SITE_URL__/tools/docs/txt-to-epub#step2"},{"@type":"HowToStep","position":3,"name":"결과 다운로드","text":"\"다운로드\" 버튼을 눌러 처리된 파일을 기기에 저장합니다.","url":"https://__SITE_URL__/tools/docs/txt-to-epub#step3"}]} as const;
