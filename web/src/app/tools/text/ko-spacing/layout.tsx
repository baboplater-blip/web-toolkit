...
const HOWTO_JSON_LD = {"@context":"https://schema.org","@type":"HowTo","name":"한글 띄어쓰기 교정 사용 방법","description":"자주 빠지는 띄어쓰기를 규칙으로 자동 교정.","inLanguage":"ko-KR","totalTime":"PT1M","tool":{"@type":"WebApplication","name":"한글 띄어쓰기 교정","url":"https://agent-control-panel-phi.vercel.app/tools/text/ko-spacing"},"step":[{"@type":"HowToStep","position":1,"name":"입력","text":"변환·분석할 텍스트나 데이터를 입력 영역에 붙여넣습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/text/ko-spacing#step1"},{"@type":"HowToStep","position":2,"name":"결과 확인","text":"결과가 실시간으로 표시됩니다. 옵션을 조절해 결과를 다듬을 수 있습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/text/ko-spacing#step2"},{"@type":"HowToStep","position":3,"name":"복사·저장","text":"결과를 클립보드에 복사하거나 파일로 내려받습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/text/ko-spacing#step3"}]} as const;
