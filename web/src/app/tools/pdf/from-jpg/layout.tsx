...
const HOWTO_JSON_LD = {"@context":"https://schema.org","@type":"HowTo","name":"여러 이미지 → PDF 사용 방법","description":"이미지를 순서대로 묶어 PDF 로 만듭니다.","inLanguage":"ko-KR","totalTime":"PT1M","tool":{"@type":"WebApplication","name":"여러 이미지 → PDF","url":"https://agent-control-panel-phi.vercel.app/tools/pdf/from-jpg"},"step":[{"@type":"HowToStep","position":1,"name":"파일 업로드","text":"도구 페이지를 열고 변환할 파일을 드롭존에 끌어다 놓거나 선택합니다. 파일은 브라우저 안에서만 처리되며 서버로 전송되지 않습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/pdf/from-jpg#step1"},{"@type":"HowToStep","position":2,"name":"옵션 설정","text":"여러 이미지 → PDF에 필요한 옵션을 화면에서 선택합니다. 미리보기로 결과를 확인할 수 있습니다.","url":"https://agent-control-panel-phi.vercel.app/tools/pdf/from-jpg#step2"},{"@type":"HowToStep","position":3,"name":"결과 다운로드","text":"\"다운로드\" 버튼을 눌러 처리된 파일을 기기에 저장합니다.","url":"https://agent-control-panel-phi.vercel.app/tools/pdf/from-jpg#step3"}]} as const;
