...
export const TOOLS: ToolMeta[] = [
  ...
  // ---- Phase 2: 이미지 ----
  {
    id: 'image-resize',
    title: '이미지 리사이즈',
    description: '가로/세로 또는 목표 용량으로 크기를 조정합니다.',
  ...
  },
  {
    id: 'image-rotate',
    title: '이미지 회전',
    description: '90/180도 회전 및 좌우 반전.',
  ...
  },
  {
    id: 'image-convert',
    title: '이미지 포맷 변환',
    description: 'JPG/PNG/WebP/AVIF 간 변환.',
  ...
  // ---- Phase 3: 보안/편집 ----
  {
    id: 'pdf-unlock',
    title: 'PDF 잠금 해제',
    description: '암호가 걸린 PDF 의 암호를 제거합니다 (비밀번호 필요).',
  ...
  },
  {
    id: 'pdf-sign',
    title: 'PDF 서명',
    description: '마우스/터치로 서명 이미지를 만들어 삽입합니다.',
    href: '/tools/pdf/sign',
    category: 'security',
    icon: PenTool,
    status: 'planned',
  ...
  },
  {
    id: 'pdf-repair',
    title: 'PDF 복구',
    description: '손상된 PDF 의 파싱 가능한 부분을 복구합니다.',
  ...
  // ---- Phase 4: AI ----
  {
    ...
    description: '한국어 포함 이미지·PDF 의 문자를 인식합니다.',
    href: '/tools/ocr',
    category: 'ai',
    icon: ScanText,
    status: 'planned',
  ...
  },
  {
    ...
    title: '배경 제거',
    description: 'AI 로 인물·상품 배경을 분리합니다.',
