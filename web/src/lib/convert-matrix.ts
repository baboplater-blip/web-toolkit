...
export const FORMATS: Record<string, FormatFact> = {
  ...
  mp3: {
    ...
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '가장 널리 쓰이는 손실 오디오 포맷으로, 어디서나 재생됩니다.', en: 'The most widely used lossy audio format that plays everywhere.', ja: '最も広く使われる非可逆オーディオ形式で、どこでも再生できます。' },
    strengths: { ko: ['모든 기기·앱에서 재생', '작은 용량', '비트레이트 조절 가능'], en: ['Plays on every device and app', 'Small files', 'Adjustable bitrate'], ja: ['あらゆる端末・アプリで再生', '小さい容量', 'ビットレートを調整可能'] },
    weaknesses: { ko: ['손실 압축 — 원본보다 음질 저하', '무손실 보관에 부적합', '메타데이터가 제한적'], en: ['Lossy — quality below the original', 'Not for lossless archiving', 'Limited metadata'], ja: ['非可逆 — 原音より音質が落ちる', '可逆保存には不向き', 'メタデータが限られる'] },
  },
  wav: {
    key: 'wav', label: 'WAV', ext: 'wav', kind: 'audio',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'large', universal: true,
    summary: { ko: '비압축 무손실 오디오 포맷으로, 편집·마스터링에 적합합니다.', en: 'An uncompressed lossless audio format ideal for editing and mastering.', ja: '無圧縮・可逆のオーディオ形式で、編集やマスタリングに適しています。' },
    strengths: { ko: ['완전 무손실 원음', '편집 워크플로 표준', '폭넓은 호환'], en: ['Fully lossless audio', 'Standard for editing workflows', 'Broad compatibility'], ja: ['完全に可逆な原音', '編集ワークフローの標準', '幅広い互換性'] },
    weaknesses: { ko: ['용량이 매우 큼', '스트리밍·공유엔 비효율', '메타데이터 빈약'], en: ['Very large files', 'Inefficient for streaming/sharing', 'Sparse metadata'], ja: ['容量が非常に大きい', 'ストリーミング・共有には非効率', 'メタデータが乏しい'] },
  },
  m4a: {
    key: 'm4a', label: 'M4A', ext: 'm4a', kind: 'audio',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'small', universal: false,
    summary: { ko: 'AAC 기반 애플 생태계 오디오 포맷으로, MP3보다 효율적입니다.', en: "An AAC-based audio format from Apple's ecosystem, more efficient than MP3.", ja: 'AACベースのApple系オーディオ形式で、MP3より効率的です。' },
    strengths: { ko: ['MP3보다 같은 용량에 좋은 음질', '아이튠즈·애플 기기 기본', '챕터·메타데이터 지원'], en: ['Better quality than MP3 at the same size', 'Default on iTunes/Apple devices', 'Supports chapters and metadata'], ja: ['同じ容量でMP3より良い音質', 'iTunes・Apple端末の標準', 'チャプター・メタデータに対応'] },
    weaknesses: { ko: ['일부 구형 기기 비호환', 'MP3만큼 범용은 아님', '편집 도구 지원이 좁음'], en: ['Incompatible with some old devices', 'Less universal than MP3', 'Narrower editor support'], ja: ['一部の古い端末で非互換', 'MP3ほど汎用的ではない', '対応する編集ツールが少ない'] },
  },
  aac: {
    key: 'aac', label: 'AAC', ext: 'aac', kind: 'audio',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'small', universal: false,
    summary: { ko: 'MP3의 후속 손실 포맷으로, 낮은 비트레이트에서 음질이 좋습니다.', en: 'A successor to MP3 with better quality at low bitrates.', ja: 'MP3の後継となる非可逆形式で、低ビットレートでも音質が良好です。' },
    strengths: { ko: ['낮은 비트레이트에서 우수한 음질', '스트리밍·방송 표준', '효율적 압축'], en: ['Great quality at low bitrates', 'Standard for streaming/broadcast', 'Efficient compression'], ja: ['低ビットレートでも優れた音質', 'ストリーミング・放送の標準', '効率的な圧縮'] },
    weaknesses: { ko: ['손실 압축', '맨 AAC는 컨테이너가 단순', '구형 기기 호환 편차'], en: ['Lossy', 'Raw AAC has a bare container', 'Patchy on old devices'], ja: ['非可逆圧縮', '生のAACはコンテナが簡素', '古い端末では互換性にばらつき'] },
  },
  ogg: {
    key: 'ogg', label: 'OGG', ext: 'ogg', kind: 'audio',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'small', universal: false,
    summary: { ko: '오픈소스 Vorbis 손실 포맷으로, 게임·웹에서 흔히 쓰입니다.', en: 'An open-source Vorbis lossy format common in games and on the web.', ja: 'オープンソースのVorbis系非可逆形式で、ゲームやWebでよく使われます。' },
    strengths: { ko: ['로열티 프리·오픈', '같은 용량에 좋은 음질', '웹·게임에서 인기'], en: ['Royalty-free and open', 'Good quality per size', 'Popular on web/games'], ja: ['ロイヤリティフリーでオープン', '同じ容量で良い音質', 'Web・ゲームで人気'] },
    weaknesses: { ko: ['애플 기본 미지원', '일부 기기 비호환', '인지도가 MP3보다 낮음'], en: ['Not supported by Apple by default', 'Incompatible with some devices', 'Less known than MP3'], ja: ['Apple標準では非対応', '一部の端末で非互換', 'MP3より知名度が低い'] },
  },
  flac: {
    key: 'flac', label: 'FLAC', ext: 'flac', kind: 'audio',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: false,
    summary: { ko: '무손실 압축 오디오 포맷으로, 원음을 보존하면서 WAV보다 작습니다.', en: 'A lossless compressed format that preserves the original while being smaller than WAV.', ja: '可逆圧縮のオーディオ形式で、原音を保ちながらWAVより小さくなります。' },
    strengths: { ko: ['무손실인데 WAV보다 작음', '풍부한 메타데이터·태그', '음원 보관에 이상적'], en: ['Lossless yet smaller than WAV', 'Rich metadata and tags', 'Ideal for archiving music'], ja: ['可逆なのにWAVより小さい', '豊富なメタデータ・タグ', '音源の保管に最適'] },
    weaknesses: { ko: ['손실 포맷보다는 큼', '일부 기기·앱 미지원', '블루투스 스트리밍 제약'], en: ['Larger than lossy formats', 'Unsupported on some devices/apps', 'Limited over Bluetooth'], ja: ['非可逆形式よりは大きい', '一部の端末・アプリで非対応', 'Bluetooth再生に制約'] },
  },
  ...
  mp4: {
    ...
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '가장 범용적인 영상 컨테이너로, 거의 모든 기기·플랫폼에서 재생됩니다.', en: 'The most universal video container, playable on virtually every device and platform.', ja: '最も汎用的な動画コンテナで、ほぼあらゆる端末・プラットフォームで再生できます。' },
    strengths: { ko: ['모든 기기·SNS·웹에서 재생', '좋은 압축 효율', '업로드 표준'], en: ['Plays on every device, social and web', 'Good compression', 'The upload standard'], ja: ['あらゆる端末・SNS・Webで再生', '良好な圧縮効率', 'アップロードの標準'] },
    weaknesses: { ko: ['투명 영상 미지원', '편집보다 배포용', '코덱에 따라 호환 편차'], en: ['No transparent video', 'For delivery, not editing', 'Codec-dependent compatibility'], ja: ['透明動画は非対応', '編集より配信向け', 'コーデック次第で互換性に差'] },
  },
  webm: {
    key: 'webm', label: 'WebM', ext: 'webm', kind: 'video',
    lossy: true, transparency: true, animation: false, vector: false,
    weight: 'small', universal: false,
    summary: { ko: '웹 최적화 오픈 영상 포맷으로, 작은 용량과 투명 영상을 지원합니다.', en: 'A web-optimized open video format with small files and transparency support.', ja: 'Web向けに最適化されたオープン動画形式で、小さい容量と透明動画に対応します。' },
    strengths: { ko: ['웹에서 가볍고 빠름', '투명 영상(알파) 지원', '로열티 프리'], en: ['Light and fast on the web', 'Supports transparent (alpha) video', 'Royalty-free'], ja: ['Webで軽くて速い', '透明動画(アルファ)に対応', 'ロイヤリティフリー'] },
    weaknesses: { ko: ['일부 기기·편집기 미지원', 'SNS 업로드 호환 편차', '사파리 구버전 제약'], en: ['Unsupported on some devices/editors', 'Patchy social upload support', 'Older Safari limits'], ja: ['一部の端末・編集ソフトで非対応', 'SNSアップロードで互換性に差', '古いSafariで制約'] },
  },
  mov: {
    key: 'mov', label: 'MOV', ext: 'mov', kind: 'video',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: false,
    summary: { ko: '애플 QuickTime 영상 포맷으로, 아이폰·편집 환경에서 흔합니다.', en: "Apple's QuickTime video format, common on iPhone and in editing.", ja: 'AppleのQuickTime動画形式で、iPhoneや編集環境でよく使われます。' },
    strengths: { ko: ['고품질 편집에 적합', '아이폰 녹화 기본', '맥 생태계 호환'], en: ['Good for high-quality editing', 'Default for iPhone recording', 'Mac ecosystem support'], ja: ['高品質な編集に向く', 'iPhone録画の標準', 'Mac環境と互換'] },
    weaknesses: { ko: ['윈도우·웹 호환 약함', '용량이 큼', '공유엔 MP4 변환 권장'], en: ['Weak Windows/web support', 'Large files', 'Convert to MP4 to share'], ja: ['Windows・Webでの互換性が弱い', '容量が大きい', '共有にはMP4への変換を推奨'] },
  },
  avi: {
    key: 'avi', label: 'AVI', ext: 'avi', kind: 'video',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'large', universal: true,
    summary: { ko: '오래된 윈도우 영상 컨테이너로, 호환은 넓지만 용량이 큽니다.', en: 'An old Windows video container — broadly compatible but large.', ja: '古いWindows系の動画コンテナで、互換性は広いものの容量が大きいです。' },
    strengths: { ko: ['구형 환경 호환', '단순한 구조', '오래된 영상 보관'], en: ['Compatible with legacy systems', 'Simple structure', 'Holds older footage'], ja: ['古い環境と互換', 'シンプルな構造', '古い映像の保管に'] },
    weaknesses: { ko: ['용량이 비효율적으로 큼', '스트리밍 부적합', '현대 코덱 기능 부족'], en: ['Inefficiently large', 'Poor for streaming', 'Lacks modern codec features'], ja: ['容量が無駄に大きい', 'ストリーミングに不向き', '最新コーデック機能が乏しい'] },
  },
  mkv: {
    key: 'mkv', label: 'MKV', ext: 'mkv', kind: 'video',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: false,
    summary: { ko: '다중 트랙·자막을 담는 유연한 오픈 컨테이너로, 고화질 보관에 인기입니다.', en: 'A flexible open container for multiple tracks and subtitles, popular for high-quality archives.', ja: '複数トラックや字幕を収められる柔軟なオープンコンテナで、高画質保管に人気です。' },
    strengths: { ko: ['다중 오디오·자막 트랙', '거의 모든 코덱 수용', '고화질 보관에 적합'], en: ['Multiple audio/subtitle tracks', 'Holds almost any codec', 'Great for HD archives'], ja: ['複数の音声・字幕トラック', 'ほぼあらゆるコーデックを収容', '高画質の保管に最適'] },
    weaknesses: { ko: ['SNS·기기 호환 약함', '브라우저 직접 재생 제한', '공유엔 MP4 변환 권장'], en: ['Weak social/device support', 'Limited direct browser playback', 'Convert to MP4 to share'], ja: ['SNS・端末での互換性が弱い', 'ブラウザでの直接再生に制約', '共有にはMP4への変換を推奨'] },
  },
  ...
  docx: {
    ...
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: true,
    summary: { ko: '마이크로소프트 워드 문서 포맷으로, 편집 가능한 서식 문서의 표준입니다.', en: 'The Microsoft Word format — the standard for editable formatted documents.', ja: 'Microsoft Wordの文書形式で、編集できる書式付き文書の標準です。' },
    strengths: { ko: ['풍부한 서식·편집', '오피스 표준', '협업·검토에 적합'], en: ['Rich formatting and editing', 'Office standard', 'Good for collaboration'], ja: ['豊富な書式と編集', 'Officeの標準', '共同作業・校閲に向く'] },
    weaknesses: { ko: ['뷰어마다 레이아웃 차이', '워드 없으면 편집 제약', '배포엔 PDF가 안정적'], en: ['Layout varies by viewer', 'Needs Word to edit fully', 'PDF is safer for distribution'], ja: ['ビューアごとにレイアウトが変わる', 'Wordがないと編集に制約', '配布にはPDFが安全'] },
  },
  md: {
    key: 'md', label: 'Markdown', ext: 'md', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: false,
    summary: { ko: '경량 텍스트 서식 포맷으로, 깃허브·문서 작성에 널리 쓰입니다.', en: 'A lightweight text markup widely used on GitHub and for docs.', ja: '軽量なテキスト記法で、GitHubや文書作成で広く使われます。' },
    strengths: { ko: ['읽기 쉬운 평문', '버전관리 친화', '어디서나 변환 가능'], en: ['Human-readable plain text', 'Version-control friendly', 'Converts anywhere'], ja: ['読みやすいプレーンテキスト', 'バージョン管理に向く', 'どこへでも変換できる'] },
    weaknesses: { ko: ['복잡한 레이아웃 한계', '렌더러마다 차이', '서식 표현이 제한적'], en: ['Limited for complex layout', 'Renderer differences', 'Limited formatting'], ja: ['複雑なレイアウトには限界', 'レンダラーごとに差が出る', '表現できる書式が限られる'] },
  },
  html: {
    key: 'html', label: 'HTML', ext: 'html', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '웹 표준 마크업으로, 브라우저에서 바로 열리는 문서 포맷입니다.', en: 'The web-standard markup that opens directly in any browser.', ja: 'Web標準のマークアップで、ブラウザでそのまま開ける文書形式です。' },
    strengths: { ko: ['모든 브라우저에서 열림', '링크·스타일·미디어 포함', '웹 게시에 최적'], en: ['Opens in every browser', 'Links, styles and media', 'Best for web publishing'], ja: ['あらゆるブラウザで開ける', 'リンク・スタイル・メディアを含む', 'Web公開に最適'] },
    weaknesses: { ko: ['인쇄·배포는 PDF가 안정적', '외부 자원 의존', '오프라인 서식 깨질 수 있음'], en: ['PDF is safer for print/share', 'Depends on external assets', 'Formatting can break offline'], ja: ['印刷・配布にはPDFが安全', '外部リソースに依存', 'オフラインで書式が崩れることがある'] },
  },
  csv: {
    key: 'csv', label: 'CSV', ext: 'csv', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '쉼표로 구분된 표 데이터 포맷으로, 거의 모든 도구가 읽습니다.', en: 'A comma-separated table format that nearly every tool can read.', ja: 'カンマ区切りの表形式データで、ほぼあらゆるツールで読み込めます。' },
    strengths: { ko: ['모든 스프레드시트·DB 호환', '가볍고 단순', '가져오기·내보내기 표준'], en: ['Works with every spreadsheet/DB', 'Light and simple', 'Standard for import/export'], ja: ['あらゆる表計算・DBと互換', '軽くてシンプル', 'インポート・エクスポートの標準'] },
    weaknesses: { ko: ['서식·수식 미보존', '중첩 데이터 표현 불가', '인코딩 이슈 가능'], en: ['No formatting/formulas', 'No nested data', 'Encoding pitfalls'], ja: ['書式・数式は保持されない', '入れ子データは表現できない', '文字コードの問題が起きやすい'] },
  },
  json: {
    key: 'json', label: 'JSON', ext: 'json', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '중첩 구조를 표현하는 데이터 포맷으로, API·설정에 표준입니다.', en: 'A data format for nested structures, standard for APIs and config.', ja: '入れ子構造を表現できるデータ形式で、APIや設定の標準です。' },
    strengths: { ko: ['중첩·계층 데이터 표현', '모든 언어가 파싱', 'API·설정 표준'], en: ['Represents nested/hierarchical data', 'Parsed by every language', 'API/config standard'], ja: ['入れ子・階層データを表現', 'あらゆる言語で解析可能', 'API・設定の標準'] },
    weaknesses: { ko: ['표 형태로 보기 불편', '용량이 CSV보다 큼', '사람이 대량 편집 어려움'], en: ['Awkward as a table', 'Larger than CSV', 'Hard to bulk-edit by hand'], ja: ['表として見るには不便', 'CSVより容量が大きい', '人手での大量編集が難しい'] },
  },
  yaml: {
    key: 'yaml', label: 'YAML', ext: 'yaml', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: false,
    summary: { ko: '들여쓰기로 구조를 표현하는 사람이 읽기 쉬운 설정 포맷입니다.', en: 'A human-readable config format that uses indentation for structure.', ja: 'インデントで構造を表す、人が読みやすい設定向けフォーマットです。' },
    strengths: { ko: ['가독성이 매우 좋음', '주석 지원', 'JSON과 상호 변환'], en: ['Very readable', 'Supports comments', 'Interconverts with JSON'], ja: ['可読性が非常に高い', 'コメントに対応', 'JSONと相互変換できる'] },
    weaknesses: { ko: ['들여쓰기 오류에 민감', '일부 환경 미지원', '복잡해지면 모호함'], en: ['Sensitive to indentation', 'Unsupported in some stacks', 'Ambiguous when complex'], ja: ['インデントのミスに弱い', '一部の環境で非対応', '複雑になると曖昧になりやすい'] },
  },
  txt: {
    key: 'txt', label: 'TXT', ext: 'txt', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '서식 없는 평문 텍스트로, 어떤 기기에서도 열립니다.', en: 'Plain text with no formatting that opens on any device.', ja: '書式のないプレーンテキストで、どんな端末でも開けます。' },
    strengths: { ko: ['완전 범용', '가볍고 단순', '깨질 일이 없음'], en: ['Universally compatible', 'Light and simple', 'Never breaks'], ja: ['完全に汎用的', '軽くてシンプル', '壊れることがない'] },
    weaknesses: { ko: ['서식·이미지 없음', '구조 표현 불가', '문서용으론 단조로움'], en: ['No formatting/images', 'No structure', 'Bare for documents'], ja: ['書式・画像がない', '構造を表現できない', '文書としては素っ気ない'] },
  },
  epub: {
    key: 'epub', label: 'EPUB', ext: 'epub', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: false,
    summary: { ko: '전자책 표준 포맷으로, 화면 크기에 맞춰 글이 재배치됩니다.', en: 'The e-book standard whose text reflows to fit any screen size.', ja: '電子書籍の標準形式で、画面サイズに合わせて文章が再配置されます。' },
    strengths: { ko: ['화면에 맞춘 가변 레이아웃', '전자책 리더 표준', '글꼴·크기 조절'], en: ['Reflows to fit the screen', 'E-reader standard', 'Adjustable font/size'], ja: ['画面に合わせて流動するレイアウト', '電子書籍リーダーの標準', 'フォント・サイズを調整可能'] },
    weaknesses: { ko: ['고정 레이아웃엔 부적합', '리더마다 렌더 차이', '인쇄엔 PDF가 나음'], en: ['Poor for fixed layouts', 'Renders differ by reader', 'PDF is better for print'], ja: ['固定レイアウトには不向き', 'リーダーごとに表示が異なる', '印刷にはPDFが向く'] },
  },
  word: {
    key: 'word', label: 'Word', ext: 'docx', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: true,
    summary: { ko: '마이크로소프트 워드(.docx) 문서로, 자유롭게 편집할 수 있습니다.', en: 'A Microsoft Word (.docx) document you can freely edit.', ja: 'Microsoft Word(.docx)文書で、自由に編集できます。' },
    strengths: { ko: ['텍스트·서식 편집 자유로움', '오피스 표준', '협업·재사용에 적합'], en: ['Freely edit text and formatting', 'Office standard', 'Good for reuse/collaboration'], ja: ['テキスト・書式を自由に編集', 'Officeの標準', '再利用・共同作業に向く'] },
    weaknesses: { ko: ['뷰어마다 레이아웃 차이', '복잡한 PDF는 완벽 재현 어려움', '워드/호환 앱 필요'], en: ['Layout varies by viewer', 'Complex PDFs may not convert perfectly', 'Needs Word or a compatible app'], ja: ['ビューアごとにレイアウトが変わる', '複雑なPDFは完全には再現しにくい', 'Wordや互換アプリが必要'] },
  },
  xlsx: {
    key: 'xlsx', label: 'XLSX', ext: 'xlsx', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: true,
    summary: { ko: '엑셀 스프레드시트 포맷으로, 표·수식·여러 시트를 담습니다.', en: 'The Excel spreadsheet format that holds tables, formulas and multiple sheets.', ja: 'Excelの表計算形式で、表・数式・複数シートを収められます。' },
    strengths: { ko: ['표·수식·서식 보존', '여러 시트를 한 파일에', '오피스·구글시트 표준'], en: ['Keeps tables, formulas and formatting', 'Many sheets in one file', 'Office/Google Sheets standard'], ja: ['表・数式・書式を保持', '複数シートを1ファイルに', 'Office・Googleスプレッドシートの標準'] },
    weaknesses: { ko: ['단순 데이터엔 과함', '프로그램 처리는 CSV·JSON이 편함', '엑셀/호환 앱 필요'], en: ['Overkill for plain data', 'CSV/JSON are easier to process programmatically', 'Needs Excel or a compatible app'], ja: ['単純なデータには過剰', 'プログラム処理にはCSV・JSONが楽', 'Excelや互換アプリが必要'] },
  },
  xml: {
    key: 'xml', label: 'XML', ext: 'xml', kind: 'document',
    lossy: false, transparency: false, animation: false, vector: false,
    weight: 'small', universal: true,
    summary: { ko: '태그로 구조를 표현하는 데이터 포맷으로, 설정·문서 교환에 쓰입니다.', en: 'A tag-based data format used for config and document exchange.', ja: 'タグで構造を表すデータ形式で、設定や文書交換に使われます。' },
    strengths: { ko: ['엄격한 구조·스키마 검증', '속성·중첩 표현', '광범위한 레거시 호환'], en: ['Strict structure and schema validation', 'Attributes and nesting', 'Broad legacy compatibility'], ja: ['厳格な構造・スキーマ検証', '属性や入れ子を表現', '広範なレガシー互換'] },
    weaknesses: { ko: ['JSON보다 장황함', '파싱이 무거움', '사람이 읽기 번거로움'], en: ['More verbose than JSON', 'Heavier to parse', 'Tedious to read by hand'], ja: ['JSONより冗長', '解析が重い', '人が読むのが面倒'] },
  },
  ...
  flv: {
    ...
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: false,
    summary: { ko: '옛 플래시 영상 포맷으로, 현대 환경에선 재생이 어려워 변환이 필요합니다.', en: 'An old Flash video format that modern players struggle with, so it needs converting.', ja: '古いFlash動画形式で、現在の環境では再生が難しく変換が必要です。' },
    strengths: { ko: ['과거 웹 스트리밍에 흔함', '오래된 영상 보관'], en: ['Common in legacy web streaming', 'Holds older footage'], ja: ['かつてのWeb配信でよく使われた', '古い映像の保管に'] },
    weaknesses: { ko: ['브라우저·기기 재생 거의 불가', '플래시 종료로 사장', 'MP4 변환 권장'], en: ['Barely plays on browsers/devices', 'Obsolete since Flash ended', 'Convert to MP4'], ja: ['ブラウザ・端末でほぼ再生不可', 'Flash終了で廃れた', 'MP4への変換を推奨'] },
  },
  wmv: {
    key: 'wmv', label: 'WMV', ext: 'wmv', kind: 'video',
    lossy: true, transparency: false, animation: false, vector: false,
    weight: 'medium', universal: false,
    summary: { ko: '윈도우 미디어 영상 포맷으로, 비윈도우 환경 호환이 약합니다.', en: 'A Windows Media video format with weak support outside Windows.', ja: 'Windows Mediaの動画形式で、Windows以外での互換性が弱いです。' },
    strengths: { ko: ['윈도우 환경 호환', '적당한 압축'], en: ['Works on Windows', 'Reasonable compression'], ja: ['Windows環境と互換', 'そこそこの圧縮'] },
    weaknesses: { ko: ['맥·모바일·웹 호환 약함', 'SNS 업로드 제약', 'MP4 변환 권장'], en: ['Weak on Mac/mobile/web', 'Limited social upload', 'Convert to MP4'], ja: ['Mac・モバイル・Webで互換性が弱い', 'SNSアップロードに制約', 'MP4への変換を推奨'] },
  },
};
...
/** 언어별 문자열을 고르는 헬퍼 (ko/en/ja 3-way). */
function pick(lang: Lang, ko: string, en: string, ja: string): string {
  return lang === 'ko' ? ko : lang === 'ja' ? ja : en;
}
...
function deriveChanges(from: FormatFact, to: FormatFact, lang: Lang): string[] {
  ...
  if (wOrder[to.weight] < wOrder[from.weight]) {
    out.push(pick(lang, '대체로 파일 용량이 줄어듭니다.', 'Files usually get smaller.', 'たいていファイル容量が小さくなります。'));
  } else if (wOrder[to.weight] > wOrder[from.weight]) {
    out.push(pick(lang, '대체로 파일 용량이 커집니다.', 'Files usually get larger.', 'たいていファイル容量が大きくなります。'));
  }
  // 호환성 변화
...
export function buildConversionContent(c: Conversion, lang: Lang): ConversionContent {
  ...
  if (!from.lossy && to.lossy) {
    faqs.push({
      q: pick(lang, `${F}를 ${To}로 바꾸면 품질이 떨어지나요?`, `Does converting ${F} to ${To} lose quality?`, `${F}を${To}に変換すると画質は落ちますか？`),
      a: pick(lang,
    ...
    faqs.push({
      q: pick(lang, `${To}로 바꾸면 화질이 좋아지나요?`, `Does converting to ${To} improve quality?`, `${To}に変換すると画質は良くなりますか？`),
      a: pick(lang,
    ...
    faqs.push({
      q: pick(lang, `${F}를 ${To}로 바꾸면 품질이 유지되나요?`, `Is quality preserved from ${F} to ${To}?`, `${F}を${To}に変換しても品質は保たれますか？`),
      a: pick(lang,
  ...
  if (from.transparency && !to.transparency) {
    faqs.push({
      q: pick(lang, '투명 배경은 어떻게 되나요?', 'What happens to the transparent background?', '透明な背景はどうなりますか？'),
      a: pick(lang,
