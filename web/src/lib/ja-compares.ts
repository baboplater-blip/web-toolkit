...
export const COMPARES_JA: Compare[] = [
  ...
  },
  {
    ...
    category: 'security',
    title: 'CRC32 vs Adler-32 — エラー検出にはどちらのチェックサム？',
    h1: 'CRC32 vs Adler-32',
    description:
      'CRC32は検出力が高い分わずかに遅く、Adler-32は速いが短いデータに弱い。どちらも偶発的な破損を検出 — 無料・ブラウザで。',
    intro:
      'CRC32とAdler-32はどちらも、ビット反転・ダウンロードの途切れ・転送ミスといった偶発的なデータ破損を検出するための32ビットチェックサムです。どちらも暗号学的ハッシュではなく、偶発的な変化を見つけるためのもので、意図的な改ざんの検出には使えません。真正性の証明には使わないでください。CRC32は多項式除算を用いてより広い範囲のエラーパターンを捉え、Adler-32は2つの累積和でバイトを足し合わせるため計算は速いものの、特に非常に短い入力では弱くなります。',
    options: [
      {
        label: 'CRC32',
        toolId: 'crc32-hash',
        best: 'より強い検出力が求められる汎用の整合性チェック。',
        pros: [
          'バーストエラーを含む多くのエラーパターンを検出',
          'ZIP・PNG・Ethernet・gzipで広く使われる',
          '短い入力でも信頼できる',
        ],
        cons: [
          'Adler-32よりわずかに計算が遅い',
          '暗号学的ではない — 偶発的な破損を検出し、改ざんは検出しない',
        ],
      },
      {
        label: 'Adler-32',
        toolId: 'adler32-hash',
        best: '大きめのブロックを速度重視でチェックするとき。',
        pros: [
          'CRC32より計算が速い',
          'シンプルな累積和方式でzlibに採用',
          '長めのデータストリームの検証に十分',
        ...
        cons: [
          '非常に短いメッセージに弱い — 先頭の和の混ざりが乏しい',
          'CRC32より多くのエラーパターンを見逃す。暗号学的ではない',
        ],
      },
    ],
    verdict:
      '特に短いデータで信頼できる整合性チェックが欲しいならCRC32を選びましょう。ZIPやPNGなどの形式で既定になっているのには理由があります。Adler-32は、より大きなブロックをチェックサムし、すべてのエラーパターンを捉えるより生の速度が重要なときだけにしましょう。いずれにせよ、これらは偶発的な破損を検出するもので、悪意ある変更ではありません。真正性が必要なら暗号学的ハッシュを使ってください。どちらもすべてブラウザ内で動きます。',
    faqs: [
      {
        q: 'CRC32とAdler-32ではどちらが安全ですか？',
        a: '暗号学的な意味ではどちらも安全ではありません。どちらも偶発的な破損を検出するだけです。改ざん耐性が必要なら、チェックサムではなくSHA-256のような暗号学的ハッシュが必要です。',
      },
      {
        q: 'Adler-32が短い入力に弱いのはなぜ？',
        a: 'Adler-32は2つの累積和を保ちますが、数バイトしかないと2つ目の和がほとんど混ざらないため、異なる短い入力が衝突しやすくなります。CRC32は短いデータでも信頼できます。',
      },
    ],
    keywords: ['crc32 adler32 違い', 'チェックサム 比較', 'エラー検出 チェックサム', 'crc32 adler-32'],
  },
  {
    slug: 'passphrase-vs-password',
    category: 'security',
    title: 'パスフレーズ vs パスワード — どちらを生成する？',
    h1: 'パスフレーズ vs パスワード',
    description:
      'パスフレーズは複数のランダムな単語を並べて覚えやすく、パスワードは短く密度の高いランダムな文字列です。選び方 — 無料・ブラウザで。',
    intro:
      'パスフレーズはランダムに選んだ複数の単語をつなぎ(correct-horse-battery-staple)、覚えやすく入力しやすいのに対し、パスワードはランダム性を短い混合文字のブロックに詰め込みます。どちらもランダムに生成すれば強くなります — 強さは「a」を「@」に置き換えることではなく、本物のエントロピーから生まれます。どちらを使うにせよ、サイト間で使い回さないこと。どちらもブラウザ内でローカルに生成され、送信されることはありません。',
    options: [
      {
        label: 'パスフレーズ',
        toolId: 'passphrase-gen',
        best: '暗記して入力する秘密 — 端末ログインやパスワードマネージャーのマスター。',
        pros: [
          'ランダムな文字列よりはるかに覚えやすく入力しやすい',
          '十分な数のランダムな単語を使えば強い',
          'モバイルのキーボードでミスが少ない',
        ],
        cons: [
          '入力に時間がかかり、短い長さ制限を超えることがある',
          'スペースや非常に長い入力を拒否するサイトもある',
        ],
      },
      {
        label: 'パスワード',
        toolId: 'password-gen',
        best: '手で入力しない、パスワードマネージャーに保存するサイトごとのログイン。',
        pros: [
          'コンパクトな長さに密なランダム性',
          '厳格な長さや文字種のルールに収まる',
          'マネージャーが自動入力してくれる場面に最適',
        ],
        cons: [
          '暗記や正確な入力が難しい',
          'スマホのキーボードで打ち間違えやすい',
    ...
    verdict:
      'PCログインやパスワードマネージャーのマスターのように、実際に覚えて入力しなければならない一握りの秘密にはパスフレーズを。それ以外のすべて、マネージャーが保存・入力してくれるものにはランダムな文字のパスワードを使いましょう。どちらも長くし、ランダムに生成し、同じ秘密を2つのサイトで決して使い回さないこと。どちらもブラウザ内で生成され、そこから出ません。',
    faqs: [
      {
        q: 'パスフレーズはパスワードより安全ですか？',
        a: '自動的にそうとは限りません — 安全性は形式ではなくランダム性と長さで決まります。長くランダムに生成したパスフレーズと長いランダムなパスワードは同じくらい強く、どちらも短ければ弱いです。',
      },
      {
        q: '強いパスフレーズを複数のサイトで使い回せますか？',
        a: 'いいえ。使い回しこそが本当のリスクです。1つのサイトが侵害されれば、その秘密を共有するすべてのアカウントが危険にさらされます。サイトごとに固有の秘密を生成し、パスワードマネージャーに保存しましょう。',
      },
    ],
    keywords: ['パスフレーズ パスワード 違い', 'ランダム パスフレーズ 生成', '強い パスワード', '単語 ベース パスワード'],
  },
  {
    slug: 'jsdoc-vs-typescript-types',
    category: 'dev',
    title: 'JSON to JSDoc vs JSON to TypeScript — どちらの型出力？',
    h1: 'JSON to JSDoc vs JSON to TypeScript',
    description:
      'ビルド不要でプレーンなJavaScriptに型を付けるJSDoc @typedefコメント、またはTypeScriptインターフェースを — どちらもJSONから、無料・ブラウザで生成。',
    intro:
      'どちらのツールもサンプルJSONから形を推論しますが、出力先が異なります。JSON to JSDocはプレーンなJavaScriptに差し込む@typedefコメントを生成し、エディタはコンパイラやビルド手順なしにそれを読んで補完や型チェックを行います。JSON to TypeScriptはTypeScriptのコードベース向けにinterface宣言を生成し、コンパイラがそれを強制します。同じ推論を2通りに使う — ドキュメントコメントか、本物の.ts型かの違いです。',
    options: [
      {
        label: 'JSON to JSDoc',
        toolId: 'json-to-jsdoc',
        best: 'TypeScriptやビルド手順を追加せずにプレーンなJavaScriptへ型を付ける。',
        pros: [
          'プレーンな.jsファイルで動く — コンパイラ不要',
          'エディタが@typedefを補完やヒントに利用',
          '既存のJSプロジェクトに手軽に散りばめられる',
        ],
        cons: [
          'コンパイル時の強制がない — チェックはエディタのみ',
          '深い入れ子の形だとコメントが冗長',
        ],
      },
      {
        ...
        toolId: 'json-to-ts',
        best: 'TypeScriptのコードベースに本物のinterface型を追加する。',
        pros: [
          'TypeScriptコンパイラが強制するinterfaceを生成',
          '入れ子や省略可能フィールドの構文がすっきり',
          '他の.ts型と統合できる',
        ],
        cons: [
          'TypeScriptの設定とビルド手順が必要',
          '小さなプレーンJavaScriptファイルには大げさ',
        ],
      },
    ],
    verdict:
      'ビルド手順を入れたくないプレーンなJavaScriptプロジェクトなら、JSDoc @typedefコメントを生成しましょう — エディタが補完と緩やかなチェックを無料で得られます。すでにTypeScriptを使っているなら、interfaceを生成してコンパイラにコード全体で形を強制させましょう。どちらも同じJSONサンプルから始まるので、プロジェクトがTypeScriptを採用するにつれて出力を切り替えられます。すべてブラウザ内で動きます。',
    faqs: [
      {
        q: 'JSDocはTypeScriptと同じチェックを提供しますか？',
        a: 'エディタの補完や警告を動かせ(tscはJSDoc経由でJSを型チェックできます)が、本物のTypeScript設定はビルド時により厳格に型を強制します。JSDocはコンパイラを追加せずに型が欲しいときに輝きます。',
      },
      {
        q: 'JSDocの出力を後でTypeScriptに変換できますか？',
        a: 'はい。プロジェクトがTypeScriptを採用したら、同じJSONをTypeScriptジェネレーターに通せばinterfaceが得られます — 推論される形は同じです。',
      },
    ],
    keywords: ['jsdoc typescript 型 違い', 'json typedef', 'json interface', 'ビルドなし javascript 型付け'],
  },
  {
    slug: 'css-keyframes-vs-cubic-bezier',
    category: 'dev',
    title: 'CSS Keyframes vs Cubic-Bezier — アニメーションかイージングか',
    h1: 'CSS Keyframes vs Cubic-Bezier',
    description:
      'keyframesは複数ステップの@keyframesアニメーション全体を定義し、cubic-bezierは1つのトランジションのイージング曲線を形作ります。どちらが必要か — 無料・ブラウザで。',
    intro:
      'これらのツールはCSSモーションの異なる2つの層にあります。keyframesジェネレーターは完全な@keyframesルール — アニメーション全体で何が、いつ変わるかという複数ステップの並びを作ります。cubic-bezierツールは単一のタイミング関数、すなわち値が継続時間にわたってどう加速・減速するかを制御するイージング曲線を作ります。keyframesは道のり全体を、cubic-bezierはその一区間のペース配分を記述します。',
    options: [
      {
        label: 'CSS Keyframes',
        toolId: 'css-keyframes',
        best: '複数ステップのアニメーション — ループ・連続・単純なA→B以上のもの。',
        pros: [
          'パーセント指定のkeyframeで多くのステップを定義',
          'ループや複雑なアニメーションを駆動',
          '貼り付けるだけの@keyframesルールを出力',
        ],
        cons: ['単純な1回のトランジションには過剰'],
      },
      {
        label: 'Cubic-Bezier',
        toolId: 'cubic-bezier',
        best: 'トランジションやアニメーションのイージング曲線の調整。',
        pros: [
          '加速と減速を精密に形作る',
          'ease・ease-in-outなどの差し替えに',
          'トランジションにもkeyframeアニメーションにも使える',
        ],
        cons: ['ペース配分のみを制御 — ステップそのものは定義できない'],
      },
    ],
    verdict:
      'モーションに複数の段階やループがあるならkeyframesジェネレーターを — そのルールが各ステップで何が起きるかを定義します。単純な始点→終点の変化で満足だが心地よく感じさせたいなら、cubic-bezierでイージングを調整しましょう。両者は補完的です。並びのために@keyframesを作り、そのうえでcubic-bezierのタイミング関数を当ててイージングを制御します。どちらもブラウザ内で動きます。',
    faqs: [
      {
        q: 'ホバーのトランジションだけならkeyframesは必要ですか？',
        a: 'いいえ。単一の状態変化はCSSトランジションで、たいていcubic-bezierのイージングだけで十分です。モーションに複数のステップや繰り返しがあるときに@keyframesを使いましょう。',
      },
      {
        q: 'keyframeアニメーションの中でcubic-bezier曲線を使えますか？',
        a: 'はい。animation-timing-functionにcubic-bezierの値を設定すれば、keyframeアニメーションが思いどおりにイージングします。2つは一緒に働きます。',
      },
    ],
    keywords: ['css keyframes cubic-bezier 違い', 'css アニメーション イージング', 'keyframes ジェネレーター', 'タイミング関数'],
  },
  {
    slug: 'color-shades-vs-tailwind-shades',
    category: 'dev',
    title: 'Color Shades vs Tailwind Shades — 自由なランプか名前付きスケールか',
    h1: 'Color Shades vs Tailwind Shades',
    description:
      'Color Shadesは任意の色から自由な明度ランプを作り、Tailwind Shadesは50〜950スケールに対応させます。どちらのパレットが必要か — 無料・ブラウザで。',
    intro:
      'どちらのツールも1色から明暗のバリエーションを生み出しますが、対象とするワークフローが違います。color-shadesツールは自由な明度ランプを作り — ステップ数や広がりを自分で選べ、固定の命名はありません。Tailwind-shadesツールは色をTailwind CSSの名前付き50〜950スケールに合わせるため、出力は番号付きトークンとしてそのままTailwindテーマに入ります。一方は柔軟なグラデーションを、もう一方はTailwind向けのステップを与えます。',
    options: [
      {
        label: 'Color Shades',
        toolId: 'color-shades',
        best: 'あらゆるデザインシステムや単発パレット向けのカスタム明度ランプ。',
        pros: [
          '任意のステップ数、自分の間隔で',
          'どのフレームワークの命名にも縛られない',
          '手作りやTailwind以外のパレットに最適',
        ],
        cons: ['ステップがTailwindの50〜950トークンと揃わない'],
      },
      {
        label: 'Tailwind Shades',
        toolId: 'tailwind-shades',
        best: 'Tailwindテーマ向けに色の50〜950ステップを生成する。',
        pros: [
          '名前付きの50・100…950スケールを出力',
          'Tailwind設定に直接貼り付け可能',
          'Tailwind既定のパレット構造と一貫',
        ],
        cons: ['50〜950レイアウトに固定 — 他のシステムには柔軟性が低い'],
      },
    ],
    verdict:
      'Tailwindプロジェクトをテーマ化するなら、出力がクラスの想定する50〜950トークンに対応するTailwind Shadesを。それ以外のデザインシステムや、ステップ数と間隔を完全に制御したいときはColor Shadesで自由な明度ランプを作りましょう。どちらも1色から始まり、すべてブラウザ内で動きます。',
    faqs: [
      {
        q: 'Tailwindプロジェクトにはどちらを使うべき？',
        a: 'Tailwind Shadesです — Tailwindのパレット構造に合う名前付きの50から950までのステップを生成するので、設定やユーティリティクラスに直接はまります。',
      },
      {
        q: 'Color Shadesは11以上のステップを作れますか？',
        a: 'はい。color-shadesのランプはステップ数とその間隔を選べるので、固定の50〜950レイアウトがシステムに合わないときに便利です。',
      },
    ],
    keywords: ['color shades tailwind shades 違い', 'カラーパレット 生成', 'tailwind 50-950', '明度 ランプ'],
  },
  {
    slug: 'cron-next-runs-vs-cron-explainer',
    category: 'dev',
    title: 'Cron Next Runs vs Cron Explainer — いつか, それとも何か',
    h1: 'Cron Next Runs vs Cron Explainer',
    description:
      'Cron Next Runsはスケジュールの次回以降の実行日時を一覧し、Cron Explainerはそれを平易な言葉で説明します。どちらが必要か — 無料・ブラウザで。',
    intro:
      'どちらのツールも同じcron式を読みますが、答える問いが違います。Cron Next Runsは実際の次回以降の発火時刻 — スケジュールがトリガーする次の一連の日時を計算するので、タイミングをひと目で確認できます。Cron Explainerは5つのフィールドを、パターンを説明する平易な一文に翻訳します。一方は次にいつ走るかを、もう一方はそのスケジュールが何を意味するかを教えます。',
    options: [
      {
        label: 'Cron Next Runs',
        toolId: 'cron-next-runs',
        best: 'スケジュールが次にいつ発火するかを正確に確認する。',
        pros: [
          '具体的な次回以降の実行日時を一覧',
          '日と曜日の奇妙な組み合わせなどの落とし穴を捉える',
          'デプロイ前のタイミング確認に最適',
        ],
        cons: ['パターンを言葉では説明しない'],
      },
      {
        ...
        toolId: 'cron-explainer',
        best: '見慣れないcron式が何を意味するかを理解する。',
        pros: [
          '5つのフィールドを平易な一文に変換',
          'パターンの論理ミスを見つける助けに',
          'ドキュメントやコードレビューで共有しやすい',
        ],
        cons: ['実際の次回以降の実行時刻は表示しない'],
      },
    ],
    verdict:
      'Cron Next Runsで実際の発火時刻を確認しましょう — 期待どおりにトリガーしないスケジュールを見つける最速の方法です。Cron Explainerは、他人の式を読んでパターンを言葉で理解する必要があるときに。両者は自然に組み合わさります。説明を読んで意図を確認し、次回以降の実行でタイミングを確認するのです。どちらもブラウザ内で動きます。',
    faqs: [
      {
        q: '日と曜日を両方指定すると、次回以降の実行が予想外になるのはなぜ？',
        a: '標準のcronでは両方のフィールドが制限されていると、どちらかが一致したときに発火し(OR)、予想より多く走ることがあります。次回以降の実行を一覧にすると、その挙動がはっきりします。',
      },
      {
        q: '説明と次回以降の実行は、どちらを先に読むべき？',
        a: '説明を読んでスケジュールが意図どおりかを確認し、次に次回以降の実行で実際のタイミングを確認しましょう。両方を使えば論理とタイミングの両方のミスを捉えられます。',
      },
    ],
    keywords: ['cron next runs cron explainer 違い', '次回 cron 実行 時刻', 'cron式 説明', 'cron スケジュール'],
  },
  {
    slug: 'csv-to-yaml-vs-csv-to-json',
    category: 'docs',
    title: 'CSV to YAML vs CSV to JSON — どちらの出力形式？',
    h1: 'CSV to YAML vs CSV to JSON',
    description:
      'CSV to YAMLは人に優しい設定向けの出力を、CSV to JSONはAPIやコード向けのコンパクトなデータを生成します。適した出力を選ぶ — 無料・ブラウザで。',
    intro:
      'どちらのツールもCSVの行を構造化レコードに変えますが、出力する形式が異なります。CSV to YAMLはインデントベースのYAMLを出力し、すっきり読めて設定ファイルや人のレビューに向きます。CSV to JSONはJSON — APIや多くのプログラミング言語の共通語 — を出力し、JSONをCSVへ戻すこともできます。同じ行を2つの行き先へ。読みやすい設定か、交換用データかの違いです。',
    options: [
      {
        label: 'CSV to YAML',
        toolId: 'csv-to-yaml',
        best: '表計算を読みやすい設定やシードデータに変える。',
        pros: [
          'インデントベースで読み書きしやすい出力',
          '設定ファイルやフィクスチャに自然になじむ',
          'セルの値から単純な型を推論',
        ],
        cons: [
          'インデントに敏感 — 手作業で壊しやすい',
      ...
      },
      {
        label: 'CSV to JSON',
        toolId: 'csv-json',
        best: 'API・コード・ツール向けのデータ生成 — そして逆変換。',
        pros: [
          'JSONはAPIや言語のあらゆる場所で扱われる',
          'CSVとJSONの双方向で変換',
          '機械にとってコンパクトで曖昧さがない',
        ],
        cons: ['かっこや引用符がYAMLより読みづらい'],
      },
    ],
    verdict:
      'プログラム・API・ライブラリが扱うデータが必要、またはCSVへ往復したいならCSV to JSONを。設定ファイルやフィクスチャ、人が読んで手編集するものを作るなら、よりすっきりしたインデントベースのCSV to YAMLを。どちらも同じCSVをブラウザ内で解析するので、一方を試してもう一方が読みやすければ切り替えられます。',
    faqs: [
      {
        q: 'どちらの形式が人にとって読みやすい？',
        a: 'たいていYAMLの方が目に優しいです。かっこや引用符の代わりにインデントを使うためで、だからこそ設定によく使われます。JSONは機械やAPIにとってより普遍的です。',
      },
      {
        q: 'JSONをCSVに戻せますか？',
        a: 'はい — CSV/JSONツールは双方向に動くので、JSONレコードをCSVの行に平坦化できます。YAMLツールはCSV→YAMLの方向に特化しています。',
      },
    ],
    keywords: ['csv yaml csv json 違い', 'csv 変換', 'csv yaml json', '表計算 設定'],
    relatedConverts: ['csv-to-json', 'json-to-csv'],
  },
  {
    slug: 'data-size-si-vs-iec',
    category: 'util',
    title: 'データサイズ(SI vs IEC) vs 単位変換 — バイトか一般単位か',
    h1: 'データサイズ(SI vs IEC) vs 単位変換',
    description:
      'データサイズ変換はSI(1000)とIEC(1024)の両方でバイトを扱い、単位変換は長さや重さなど一般的な計量を扱います — 無料・ブラウザで。',
    intro:
      'これらのツールはどちらも単位を変換しますが、扱う領域が違います。データサイズ変換はデジタルストレージ専用で、SIの定義(1 kB = 1000バイト、ディスクのパッケージ表記)とIECの定義(1 KiB = 1024バイト、OSがよく数える方法)の両方を示すため、「1 TB」のドライブが少なく表示される理由がわかります。一般の単位変換は長さ・重さ・温度・体積など日常の物理的な計量を扱いますが、1000対1024のバイトの違いは扱いません。',
    options: [
      {
        label: 'データサイズ変換',
        toolId: 'data-size-converter',
        best: 'SIとIECの区別を明示しつつバイトやビットを変換する。',
        pros: [
          'SI(1000)とIEC(1024)の結果を並べて表示',
          '「1 TBドライブが少なく表示される」食い違いを説明',
          'バイト・KB/KiB・MB/MiB・GB/GiB以上をカバー',
        ],
        cons: ['デジタルストレージ単位に限定、物理的な計量は扱わない'],
      },
      {
        label: '単位変換',
        toolId: 'unit-converter',
        best: '長さ・重さ・温度・体積など日常の変換。',
        pros: [
          '多くの物理カテゴリを一か所でカバー',
          '料理・旅行・一般的な計算に便利',
          'コピーできるシンプルで速い変換',
        ],
        cons: ['SI対IECのバイトの区別はモデル化しない'],
      },
    ],
    verdict:
      'データサイズを変換し、1000対1024でドライブが表示より小さく見える理由も理解したいなら、SIとIECの両方を示すデータサイズ変換を。長さ・重さ・温度・体積といった日常の物理的な計量には一般の単位変換を。両者は別々の領域を扱うので、測るものに合わせて選びましょう。どちらもブラウザ内で動きます。',
    faqs: [
      {
        q: 'データサイズ変換が2つの異なる数値を示すのはなぜ？',
        a: '2つの慣習を示すためです。SIは1 kBを1000バイトと数え(ストレージのパッケージで使用)、IECは1 KiBを1024バイトと数えます(OSがよく報告する方法)。両方を見ると、新しいドライブの一見した不足分が説明できます。',
      },
      {
        q: '一般の単位変換でギガバイトを扱えますか？',
        a: '1000対1024の違いを含むデジタルストレージにはデータサイズ変換を使ってください。一般の単位変換は長さ・重さ・温度・体積といった物理的な計量に特化しています。',
      },
    ],
    keywords: ['データサイズ si iec', '1000 1024 バイト', 'gb gib', 'データサイズ 変換'],
  },
];
