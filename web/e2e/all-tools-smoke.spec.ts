...
const TOOL_ROUTES: string[] = [
  ...
  '/tools/dev/css-minify',
  '/tools/dev/css-specificity',
  '/tools/dev/css-units',
  ...
  '/tools/dev/json-diff',
  '/tools/dev/json-sort-keys',
  '/tools/dev/json-to-go',
  '/tools/dev/json-to-python',
  ...
  '/tools/dev/uuid',
  '/tools/dev/uuid-namespace',
  '/tools/docs/csv-diff',
  '/tools/docs/csv-json',
  '/tools/docs/csv-merge',
  '/tools/docs/csv-split',
  '/tools/docs/csv-stats',
  ...
  '/tools/security/cc-validate',
  '/tools/security/checksum-verify',
  ...
  '/tools/text/count',
  '/tools/text/count-occurrences',
  '/tools/text/dedupe-lines',
  '/tools/text/diff',
  '/tools/text/extract-emails',
  '/tools/text/extract-urls',
  '/tools/text/fancy',
  '/tools/text/hanja',
  ...
  '/tools/util/compound-interest',
  '/tools/util/date-diff',
  '/tools/util/dday',
  '/tools/util/dice-roller',
  '/tools/util/discount',
  '/tools/util/electricity-cost',
