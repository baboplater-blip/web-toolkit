...
const TOOL_ROUTES: string[] = [
  ...
  '/tools/dev/color-shades',
  '/tools/dev/cron',
  '/tools/dev/cron-next-runs',
  '/tools/dev/crontab-builder',
  '/tools/dev/css-clamp',
  '/tools/dev/css-gradient',
  '/tools/dev/css-grid',
  '/tools/dev/css-keyframes',
  ...
  '/tools/image/image-ascii-braille',
  '/tools/image/image-mirror-tile',
  '/tools/image/info',
  '/tools/image/meme',
  '/tools/image/noise',
  ...
  '/tools/text/morse',
  '/tools/text/nato',
  '/tools/text/number-extract',
  '/tools/text/pig-latin',
  '/tools/text/prefix-suffix-lines',
  ...
  '/tools/text/text-stats-table',
  '/tools/text/text-to-columns',
  '/tools/text/tts',
  ...
  '/tools/util/data-size-converter',
  '/tools/util/date-add',
  ...
  '/tools/util/discount',
  '/tools/util/dog-age',
  '/tools/util/download-time-calc',
  '/tools/util/due-date',
  '/tools/util/electricity-cost',
  '/tools/util/fov-calc',
  '/tools/util/frame-time-calc',
  ...
  '/tools/util/resistor-color-code',
...
test.describe('전 도구 마운트 스모크 (445)', () => {
